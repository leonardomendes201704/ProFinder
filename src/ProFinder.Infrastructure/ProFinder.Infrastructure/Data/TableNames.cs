...
{
    public const string Professions = "prf_professions";
    public const string LeadSources = "prf_lead_sources";
    ...
    public const string LeadCaptureRuns = "prf_lead_capture_runs";
